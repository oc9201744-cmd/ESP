...
{
public:
	class UWidgetTree*                                 WidgetTree;                                               // 0x03D0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bAllowTemplate : 1;                                       // 0x03D8(0x0001)
	unsigned char                                      bValidTemplate : 1;                                       // 0x03D8(0x0001)
	unsigned char                                      bTemplateInitialized : 1;                                 // 0x03D8(0x0001) (Transient)
	unsigned char                                      bCookedTemplate : 1;                                      // 0x03D8(0x0001) (Transient)
	unsigned char                                      bClassRequiresNativeTick : 1;                             // 0x03D8(0x0001)
	unsigned char                                      UnknownData00[0x7];                                       // 0x03D9(0x0007) MISSED OFFSET
	TArray<struct FDelegateRuntimeBinding>             Bindings;                                                 // 0x03E0(0x0010) (ZeroConstructor)
	TArray<class UWidgetAnimation*>                    Animations;                                               // 0x03F0(0x0010) (ExportObject, ZeroConstructor)
	TArray<struct FName>                               NamedSlots;                                               // 0x0400(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x28];                                      // 0x0410(0x0028) UNKNOWN PROPERTY: SoftObjectProperty UMG.WidgetBlueprintGeneratedClass.TemplateAsset
	class UUserWidget*                                 Template;                                                 // 0x0438(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
