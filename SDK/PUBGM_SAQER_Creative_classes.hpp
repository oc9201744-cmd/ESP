...
public:
	...
	unsigned char                                      UnknownData00[0x46];                                      // 0x016A(0x0046) MISSED OFFSET
	TArray<struct FString>                             GridLevelList;                                            // 0x01B0(0x0010) (ZeroConstructor)
	TMap<struct FString, struct FCreativeModeGridLevelConfig> GridLevelConfigs;                                         // 0x01C0(0x0050) (ZeroConstructor)
	TMap<struct FString, struct FCreativeModeGridLevelInfo> GridLevelsMap;                                            // 0x0210(0x0050) (ZeroConstructor)
	TMap<struct FString, struct FIntVector>            ObjectCellIndexMap;                                       // 0x0260(0x0050) (ZeroConstructor)
	TArray<struct FString>                             AlwaysLoadLevel;                                          // 0x02B0(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x10];                                      // 0x02C0(0x0010) MISSED OFFSET
	TArray<struct FString>                             RefreshBatchDataInstances;                                // 0x02D0(0x0010) (ZeroConstructor)
	bool                                               bStaticMeshObjectBatchSwitch;                             // 0x02E0(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bAroundRelieveBatchSwitch;                                // 0x02E1(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x02E2(0x0002) MISSED OFFSET
	float                                              EditorModeUpdateTime;                                     // 0x02E4(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              DelayUpdateBatchTime;                                     // 0x02E8(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              TickUpdateBatchInterval;                                  // 0x02EC(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              ReBatchDistance;                                          // 0x02F0(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              RelieveBatchDistance;                                     // 0x02F4(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bRelieveBatchDelayUpdateSwitch;                           // 0x02F8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x02F9(0x0003) MISSED OFFSET
	float                                              RelieveBatchDelayTime;                                    // 0x02FC(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bIncrementalRefreshEnable;                                // 0x0300(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bHISMBatchForceSwitch;                                    // 0x0301(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bFineBatchSwitch;                                         // 0x0302(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bDynamicChangeHISMSwitch;                                 // 0x0303(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bPostUpdateISMBufferCompleteEventFlag;                    // 0x0304(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x0305(0x0003) MISSED OFFSET
	int                                                UpdateIsmNumPerFrame;                                     // 0x0308(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x194];                                     // 0x030C(0x0194) MISSED OFFSET
	TMap<struct FString, class ACreativeModeStaticMeshBatchActor*> SingleBatchActorMap;                                      // 0x04A0(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData06[0xF0];                                      // 0x04F0(0x00F0) MISSED OFFSET
	TArray<struct FString>                             ChangeMaterialIdInstanceIDs;                              // 0x05E0(0x0010) (ZeroConstructor)
...
public:
	...
	unsigned char                                      UnknownData01[0x43];                                      // 0x017D(0x0043) MISSED OFFSET
	TMap<struct FString, struct FCreativeModeStreamingParameters> ObjectStreamingStateMap;                                  // 0x01C0(0x0050) (ZeroConstructor, Transient)
	TArray<struct FString>                             ObjectStreamingStateKeyList;                              // 0x0210(0x0010) (ZeroConstructor, Transient)
	TMap<struct FString, bool>                         ObjectSpawnStateChangeMaps;                               // 0x0220(0x0050) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData02[0x50];                                      // 0x0270(0x0050) MISSED OFFSET
	TArray<TWeakObjectPtr<class AActor>>               OuterStreamingSources;                                    // 0x02C0(0x0010) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData03[0xC8];                                      // 0x02D0(0x00C8) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData00[0x76];                                      // 0x002A(0x0076) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData07[0x47];                                      // 0x0771(0x0047) MISSED OFFSET
