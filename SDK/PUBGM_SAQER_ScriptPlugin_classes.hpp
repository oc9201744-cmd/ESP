...
{
public:
	TArray<unsigned char>                              ByteCode;                                                 // 0x03D0(0x0010) (ZeroConstructor)
	struct FString                                     SourceCode;                                               // 0x03E0(0x0010) (ZeroConstructor)
	TArray<class UProperty*>                           ScriptProperties;                                         // 0x03F0(0x0010) (ZeroConstructor)
