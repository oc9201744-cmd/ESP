...
public:
	...
	unsigned char                                      UnknownData00[0x46];                                      // 0x04C2(0x0046) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData02[0x80];                                      // 0x0168(0x0080) MISSED OFFSET
	TArray<uint16_t>                                   TotalPlayCountRecord;                                     // 0x01E8(0x0010) (ZeroConstructor)
	TMap<struct FString, unsigned char>                ObjectPlayCountRecord;                                    // 0x01F8(0x0050) (ZeroConstructor)
	TMap<unsigned char, struct FAKErrorInfo>           AkErrorRecord;                                            // 0x0248(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAKErrorInfo>                AkDetailErrorCodeRecord;                                  // 0x0298(0x0050) (ZeroConstructor)
	struct FScriptMulticastDelegate                    AkAudioDetailErrorCodeDelegate;                           // 0x02E8(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    AkAudioEventTrigger;                                      // 0x02F8(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	float                                              nPassedTime;                                              // 0x0308(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              nUpdateInterval;                                          // 0x030C(0x0004) (ZeroConstructor, IsPlainOldData)
	TMap<struct FString, int8_t>                       BankRefList;                                              // 0x0310(0x0050) (ZeroConstructor)
	TArray<struct FString>                             EventList;                                                // 0x0360(0x0010) (ZeroConstructor)
